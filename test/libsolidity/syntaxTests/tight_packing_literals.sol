...
// Warning: (77-89): This function only accepts a single 'bytes' argument. Please use 'abi.encodePacked(...)' or a similar function to encode the data. The provided argument of type int_const 1 cannot be implictly converted to bytes memory.
...
// Warning: (161-168): This function only accepts a single 'bytes' argument. Please use 'abi.encodePacked(...)' or a similar function to encode the data. The provided argument of type int_const 1 cannot be implictly converted to bytes memory.
...
// Warning: (240-249): This function only accepts a single 'bytes' argument. Please use 'abi.encodePacked(...)' or a similar function to encode the data. The provided argument of type int_const 1 cannot be implictly converted to bytes memory.
...
// Warning: (321-333): This function only accepts a single 'bytes' argument. Please use 'abi.encodePacked(...)' or a similar function to encode the data. The provided argument of type int_const 1 cannot be implictly converted to bytes memory.
